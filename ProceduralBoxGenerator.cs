...
public class BoxGenerator : MeshGenerator<BoxGenerator>
{
	...
	public BoxGenerator(float sizeX, float sizeY, float sizeZ, uint numSegX, uint numSegY) : this(sizeX, sizeY, sizeZ, numSegX, numSegY, 1)
	{
	}
	public BoxGenerator(float sizeX, float sizeY, float sizeZ, uint numSegX) : this(sizeX, sizeY, sizeZ, numSegX, 1, 1)
	{
	}
	public BoxGenerator(float sizeX, float sizeY, float sizeZ) : this(sizeX, sizeY, sizeZ, 1, 1, 1)
	{
	}
	public BoxGenerator(float sizeX, float sizeY) : this(sizeX, sizeY, 1.0f, 1, 1, 1)
	{
	}
	public BoxGenerator(float sizeX) : this(sizeX, 1.0f, 1.0f, 1, 1, 1)
	{
	}
	public BoxGenerator() : this(1.0f, 1.0f, 1.0f, 1, 1, 1)
	{
	}
