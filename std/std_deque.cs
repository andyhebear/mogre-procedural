...
{
    /// <summary>
    ///like C++ std::deque 双端列队
    ///c#具体实现可以参考文章 http://www.codeproject.com/Articles/11754/A-Deque-Class-in-C
   ...
   public class std_deque<T> : ICollection<T>
   {
       #region Constants
       ...
       public std_deque(ICollection<T> collection)
           : this() {
